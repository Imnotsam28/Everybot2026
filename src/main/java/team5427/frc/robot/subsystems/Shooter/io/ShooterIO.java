...
public interface ShooterIO {
    ...
    public static class ShooterIOInputs {
        ...
        public LinearVelocity kShooterMotorSlaveLinearVelocity = MetersPerSecond.of(0.0);
        public AngularVelocity kShooterMotorSlaveAngularVelocity = RotationsPerSecond.of(0.0);
        public LinearAcceleration kShooterMotorSlaveAcceleration = MetersPerSecondPerSecond.of(0.0);
        public Voltage kShooterMotorSlaveVoltage = Volts.of(0.0);
        public Current kShooterMotorSlaveCurrent = Amps.of(0.0);
        public Temperature kShooterMotorSlaveTemperature = Celsius.of(0.0);
